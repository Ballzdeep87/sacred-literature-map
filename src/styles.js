...
export const S = {
  ...
  shareBtn: { position: "absolute", top: "12px", right: "38px", background: "transparent", border: "none", color: "#8a815f", cursor: "pointer", display: "inline-flex" },
  shareBtnActive: { color: "#e6b84a" },
  pDate: { fontFamily: mono, fontSize: "12px", color: "#c9a94a", marginBottom: "4px" },
  pTitle: { fontFamily: serif, fontSize: "21px", margin: "0 0 10px", color: "#f4ecd6", lineHeight: 1.2, paddingRight: "56px" },
  ...
  timelineScroll: { overflowX: "auto", overflowY: "hidden" },
